...
class CursorWindow:
    ...
    def follow(self, mousePos):
        ...
        zoom_edge_left = (self.zoom_x
                          + int(self.active_border * borderScale))+50
        zoom_edge_right = (self.zoom_x
                           + self.zoom_w
                           - int(self.active_border * borderScale))-1150
        zoom_edge_top = 500+(self.zoom_y
                         + int(self.active_border * borderScale))
        zoom_edge_bottom = (self.zoom_y
                            + self.zoom_h
                            - int(self.active_border * borderScale))-100
